    ...
    <section id="app" className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="glass-card border border-white/[0.08] px-6 py-3.5 rounded-2xl text-sm font-semibold text-white flex items-center gap-3 justify-center hover:border-white/20 transition-all"
              >
          ...
          {/* Right: Phone mockups */}
          <div className="flex items-end justify-center gap-3 py-16 relative">
            {/* Background glow */}
